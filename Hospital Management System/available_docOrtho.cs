...
namespace Hospital_Management_System
{
    public partial class available_docOrtho : Form
    {
        ...
        public void loadform()
        {
            ...
            con.Open();
            string querry = "select * from Appointment where doctor_id=" + ortho.doctor_id;
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            string querry = "select * from Appointment where doctor_id=" + ortho.doctor_id + " and time_from=@tf and time_to=@tt and appointment_date=@ad";
            ...
            else
            {
                ...
                cmd1.Parameters.AddWithValue("@docid", ortho.doctor_id);
