...
{
    public partial class patient_notadmittreatment : Form
    {
        public patient_notadmittreatment()
        {
            InitializeComponent();
        ...
        {
            patient_patientdiseases ps=new patient_patientdiseases();
            this.Hide();
            ps.Show();
        }
    }
